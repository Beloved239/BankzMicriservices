package com.tobi.cards.controller;


import com.tobi.cards.constant.CardConstants;
import com.tobi.cards.dto.CardDto;
import com.tobi.cards.dto.ErrorResponseDto;
import com.tobi.cards.dto.ResponseDto;
...
@Tag(
        name = "CRUD REST APIs for Cards in Dollar Bank",
        description = "CRUD REST APIs in Dollar Bank to CREATE, UPDATE, FETCH AND DELETE card details"
)
@RestController
...
public class CardController {
    ...
    @Operation(
            ...
            description = "REST API to create new Card inside Dollar Bank"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "201",
    ...
    @Operation(
            ...
            description = "REST API to delete Card details based on phone number"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
